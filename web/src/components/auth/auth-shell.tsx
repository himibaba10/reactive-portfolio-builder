...
export function AuthShell({
  ...
  return (
    <main className="relative flex min-h-svh flex-col items-center justify-center overflow-hidden bg-[var(--ink)] px-5 py-16 text-[var(--foam)]">
      <div
        aria-hidden
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <h1 className="font-[family-name:var(--font-display)] text-3xl tracking-[-0.04em] md:text-4xl">
          {title}
        </h1>
        {subtitle ? (
