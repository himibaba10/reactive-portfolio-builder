...
export function CtaSection({ section }: SectionProps) {
    ...
    return (
      ...
      >
        ...
        <div className="relative max-w-2xl space-y-4">
          ...
          {cta.showBody && cta.body ? (
            <p className="text-base opacity-80 whitespace-pre-wrap">{cta.body}</p>
          ) : null}
  ...
  return (
    <section
      id="cta"
      className="relative min-h-[min(52vh,420px)] overflow-hidden rounded-[2rem] border border-white/10 bg-black/35 md:rounded-[2.5rem]"
    >
      {cta.showImage && cta.imageUrl ? (
